package org.iplantc.de.theme.base.client.apps.list.cells;
...
public class AppHyperlinkCellDefaultAppearance implements AppHyperlinkCell.AppHyperlinkCellAppearance {
    ...
    public interface Templates extends SafeHtmlTemplates {
        ...
        @Template("<span name='{3}' class='{0}' qtip='{2}'>{1}</span>")
        SafeHtml cell(String textClassName, SafeHtml name, String textToolTip, String elementName);

        @Template("<span id='{4}' name='{3}' class='{0}' qtip='{2}'>{1}</span>")
        SafeHtml debugCell(String textClassName,
                           SafeHtml name,
                           String textToolTip,
                           String elementName,
                           String debugId);
